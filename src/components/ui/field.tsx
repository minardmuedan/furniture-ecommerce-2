...
function FieldLegend({ className, variant = 'legend', ...props }: React.ComponentProps<'legend'> & { variant?: 'legend' | 'label' }) {
  return (
    <legend
      ...
      className={cn('mb-3 font-normal', 'data-[variant=legend]:text-base', 'data-[variant=label]:text-sm', className)}
      {...props}
    />
  )
}
...
function FieldDescription({ className, ...props }: React.ComponentProps<'p'>) {
  return (
    <p
      ...
      className={cn(
        'text-muted-foreground text-sm leading-normal font-light group-has-data-[orientation=horizontal]/field:text-balance',
...
function FieldError({
  ...
  return (
    <div role="alert" data-slot="field-error" className={cn('text-destructive text-sm font-light', className)} {...props}>
      {content}
    </div>
  )
}
